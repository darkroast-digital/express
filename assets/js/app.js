...
window.fx = __webpack_require__(6);
...
for (i; i < icons.length; i++) {
    ...
    if (icons[i].dataset.icon in paths) {
        var iconTemplate = '<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"><g class="icon icon-' + icons[i].dataset.icon + '" stroke-linecap="round" stroke-linejoin="round"><path d="' + paths[icons[i].dataset.icon] + '"></path></g></svg>';
